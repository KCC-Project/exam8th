...
<div id="page-content-wrapper">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
					...
					<div class="row form-group">
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input name="s_subject_name" placeholder="Enter Subject Name"
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input name="s_subject_code" placeholder="Enter Subject code"
									class="form-control" type="text">
							</div>
						</div>
						<div class="col-sm-4">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-success" id="updateClicked"
	...
	<form id="faculty-add-form" method="post" class="form-horizontal well"
		style="display: none;">
	...
	<form id="faculty-edit-form" method="post" class="form-horizontal well"
		style="display: none;">
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-md-12">
				<button type="submit" id="editFaculty"
