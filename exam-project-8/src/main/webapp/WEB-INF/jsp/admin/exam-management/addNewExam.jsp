	...
	<form id="add-exam-form" method="post" class="form-horizontal well">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				...
				<div class="col-md-6">
					Semester no.:<select class="form-control" id="s-semester-no"
						name="s_semester_no">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="col-md-6">
					Subject_Name<select required class="form-control" id="subject-box"
						name="subject_id">
					</select>
				</div>
				<div class="col-md-6">
					Exam_type:<select required class="form-control" id="exam-type-box"
						name="exam_type_id">
					</select>
				</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="col-md-6">
					Full Marks<input type="number" class="form-control"
						name="full_marks" />
				</div>
				<div class="col-md-6">
					Pass Marks<input type="number" class="form-control"
						name="pass_marks" />
				</div>
			</div>
		</div>
